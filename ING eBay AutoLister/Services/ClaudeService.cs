...
public class ClaudeService(CredentialsStore creds)
{
    ...
    private const string ListingSchema = """
        ...
        {
          "Title": "CRITICAL: max 80 chars — lead with brand+model+type, pack in search keywords. Example: 'Bitmain Antminer S19j Pro 104TH ASIC Bitcoin Miner — PSU Included Used'",
          "Subtitle": "",
          "Category": "best matching eBay leaf category name",
          "CategoryId": "eBay numeric LEAF category ID — must be a leaf (no subcategories). CATEGORY RULES: 179171=ALL mining hardware (ASIC miners, hash boards, control boards, mining PSUs, mining fans, test fixtures, miner repair tools, mining accessories — EVERYTHING mining goes here); 180959=Vitamins & Supplements; 64800=Electronic Components; 9355=Cell Phones; 175672=Laptops; 3676=Cameras; 11450=Men Clothing; 15724=Women Clothing; 267=Books; 220=Toys; 1249=Video Games; 139971=Auto Parts; 42017=Computer Power Supplies (non-mining); 1244=Motherboards (non-mining). When in doubt for mining → 179171.",
          "SecondaryCategoryId": "",
    ...
    private const string HtmlTemplateInstructions = """
        ...
        <div style="font-family:Arial,sans-serif;max-width:760px;margin:0 auto;color:#222;font-size:14px;line-height:1.7">
          ...
          <p style="margin:0 0 14px">[KEYWORD-RICH opening sentence. Brand + Model + what it is + who it's for. Pack in the most searched terms naturally. Example: "Bitmain Antminer S19 Pro 110TH/s Bitcoin ASIC miner — high-efficiency SHA-256 mining rig for serious BTC miners seeking proven hashrate and low power consumption."]</p>
          ...
          <ul style="margin:0 0 16px 16px;padding:0">
            <li>[Spec with number — e.g. "Hashrate: 110 TH/s ±3%"]</li>
            <li>[Spec with number — e.g. "Power: 3250W ±5% at 25°C"]</li>
            <li>[Spec — e.g. "Algorithm: SHA-256 (Bitcoin, Bitcoin Cash)"]</li>
            <li>[Spec — e.g. "Dimensions: 400 × 195 × 290 mm"]</li>
            <li>[Add all relevant specs — be specific and complete]</li>
          </ul>
          ...
          <ul style="margin:0 0 16px 16px;padding:0">
            <li>[Exactly what ships — e.g. "1x Antminer S19 Pro unit"]</li>
            <li>[PSU included or not — critical for miners]</li>
            <li>[Power cables, accessories if any]</li>
          </ul>
